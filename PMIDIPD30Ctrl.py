...
class PMIDIPD30Ctrl(SimpleControllerBase):
  ...
  def _setup(self):
    # Set up transport.
    self._register_button(self.__toggle_record, 44)
    ...
    self._register_button(partial(self.__set_crossfader, 0), 1)
    self._register_button(partial(self.__set_crossfader, 127), 2)
